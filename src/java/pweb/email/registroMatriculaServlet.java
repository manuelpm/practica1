 ...
 * @author alumno
 */
@WebServlet(name = "registroMatriculaServlet", urlPatterns = {"/registroMatriculaServlet"})
public class registroMatriculaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String url = "/registro_alumno.jsp";
        ...
        if (action.equals("join")) {
            url = "/registro_alumno.jsp";    // la pagina "join" 
        }
            ...
            User LOGIN = new User(firstName, lastName, email);
            UserDB.insert(LOGIN);
            
            // establecer objeto Usuario en el objeto request y establecer la URL
            request.setAttribute("LOGIN", LOGIN);
            url = "/registro_matricula.jsp";   // the "thanks" page
        }
